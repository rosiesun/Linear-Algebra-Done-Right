...
$\Leftarrow$
Suppose $T^{\ast}$ is surjective. Then $range T^{\ast} = V$. We have 
...
Then $null T^{\ast} = \\{0\\}$. Hence we conclude $T^{\ast}$ is injective.

$\Leftarrow$
Suppose $T^{\ast}$ is injective. Then $null T^{\ast} = \\{0\\}$. We have 
