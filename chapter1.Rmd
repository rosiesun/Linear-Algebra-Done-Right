...
*(Had to get a hint from Claude for direction 2. A lot of times you just had to FEEL what's the right starting point. Otherwise you're just in purgatory.)*
...
*(This was a tough one! I guess I simply lack imagination (which means I cannot be a mathematician). Had to ask Claude.)*
