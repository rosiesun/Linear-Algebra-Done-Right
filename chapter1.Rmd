...
5) Show that in the definition of a vector space (1.20), the additive inverse condition can be replaced with the condition that $0v=0$ for all $v \in V$. Here the 0 on the left side is the number 0, and the 0 on the right side is the additive identity of $V$. *(Disclaimer: Had to get a hint from Claude for direction 2. Why is math so hard. This reminds me why I didn't like proofs in school. A lot of times you just had to FEEL what's the right starting point. Otherwise you're just in purgatory.)*
